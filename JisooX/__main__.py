...
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/OrochimaruBotz/JisooXRobot.git)
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/0125e8e8815bd3d495029.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="[► Help ◄]",callback_data="help_back"),InlineKeyboardButton(text="[► Creator ◄]",url="https://t.me/BijiKacang")]]
    keyboard += [[InlineKeyboardButton(text="[► Source ◄]",url="https://github.com"),InlineKeyboardButton(text="[► Add Me ◄]",url="t.me/{}?startgroup=true".format(bot.username))]]
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="[► Creator ◄]",url="https://t.me/BijiKacang")]]))
        return
